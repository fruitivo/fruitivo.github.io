...
export const EN = {
  ...
  secret: {
    ...
    paragraph1: "By day, we’re an orchard like any other — sun, irrigation, rigorous soil checks. But once the sun goes down, the second shift begins. Deep beneath the roots, where our official property map ends, our most experienced people have a second job: cultivating strains in our top-tier regenerated microbiome that wouldn't stand a chance elsewhere, blossoming into fragrant, resinous buds of pure, honest power.",
    paragraph2: "When the soil thrives, everything thrives. Our secret harvest might be missing from standard spreadsheets, but it gets the most honest care. And if you ever need the absolute best proof that our regenerative methods work deep down, just look at the remarkably relaxed atmosphere at our late-night team meetings.",
